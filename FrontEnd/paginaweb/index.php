        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/paginaweb/img/8225.jpg" alt="Los Angeles" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="/paginaweb/img/897.jpg" alt="Chicago" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="/paginaweb/img/lulaxbolso.jpg" alt="New York" class="d-block w-100">
                </div>
            </div>
            ...
            <div class="btn-row">
                <div class="btn-box">
                    <button class="btn-small">
                        <img src="/paginaweb/img/dumbbell.png" alt="">
                    </button>
                ...
                <div class="btn-box">
                    <button class="btn-small">
                        <img src="/paginaweb/img/sportsman.png" alt="">
                    </button>
                    <div class="btn-caption">
                        <h3>Algum Texto</h3>
                    </div>
                ...
                <div class="btn-box">
                    <button class="btn-small">
                        <img src="/paginaweb/img/location.png" alt="">
                    </button>
                    <div class="btn-caption">
                        <h3>Algum Texto</h3>
                    </div>
            ...
            <div class="btn-row">
                <div class="btn-box">
                    <button class="btn-medium">
                        <img src="/paginaweb/img/chat.png" alt="">
                    </button>
                    <div class="btn-caption">
                        <h3>Algum Texto</h3>
                    </div>
                ...
                <div class="btn-box">
                    <button class="btn-medium">
                        <img src="/paginaweb/img/invoice.png" alt="">
                    </button>
                    <div class="btn-caption">
                        <h3>Algum Texto</h3>
                    </div>
            ...
            <div class="btn-row">
                <div class="btn-box">
                    <button class="btn-large">
                        <img src="/paginaweb/img/calendar.png" alt="">
                    </button>
                    <div class="btn-caption">
                        <h3>Algum Texto</h3>
                    </div>
                ...
                <div class="btn-box">
                    <button class="btn-large">
                        <img src="/paginaweb/img/note.png" alt="">
                    </button>
                    <div class="btn-caption">
                        <h3>Algum Texto</h3>
                    </div>
