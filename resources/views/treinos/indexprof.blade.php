                                        ...
                                        <div class="div" style="border:solid 2px black; padding:15px;">
                                            <a href="{{ url('/treinos/create/' . $aluno->id) }}">
                                                @if ($aluno->status_treino == 0)
                                                    <h2>{{ $aluno->nome }} {{ $aluno->sobrenome }} Data de Nascimento:{{ date('d/m/Y', strtotime($aluno->dataNascimento)) }} idade:{{ $aluno->dataNascimento->age}} SEM TREINO</h2>
                                                @else
                                                    <h2>{{ $aluno->nome }} {{ $aluno->sobrenome }} {{ $aluno->dataNascimento }} COM TREINO</h2>
                                                @endif
                                            </a>
                                        </div>
                                    </div>
