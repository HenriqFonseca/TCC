        ...
        <div class="wrapper">
            ...
            <div class="cadastro">
                <form class="form-signin" method="POST"  action="{{ route('user.register') }}">
                    ...
                    <br>
                    <div class="select_user"><a href="{{ route('profile.register_aluno') }}" id="active-user">Aluno</a><a href="{{ route('profile.register_professor') }}" >Instrutor</a></div>
                    <br>
                    <div class="nome">
                        ...
                        <div class="container-erro-nome">
                            ...
                            <div class="container-error-message">@error('nome') <span class="error-message">{{ $message }}</span> @enderror</div>                            @else
                        ...
                        <div class="container-erro">
                            ...
                            <div class="container-error-message">@error('sobrenome') <span class="error-message">{{ $message }}</span> @enderror</div>                            @else class="input" name="sobrenome" placeholder="Sobrenome" />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="container-erro" style="width: 100%">
                        <div class="container-erro">
                            ...
                            class="input-error" name="dataNascimento" id="dataNascimento" autocomplete="off" maxlength="8" placeholder="" />
                            <div class="container-error-message">@error('dataNascimento') <span class="error-message">{{ $message }}</span> @enderror</div>
                            @else class="input" name="dataNascimento" id="dataNascimento" maxlength="8" autocomplete="off" placeholder="" />
                            @endif 
                        </div>
                    </div>
                    ...
                    <div class="container-erro" style="width: 100%">
                        <div class="container-erro">
                            ...
                            <div class="container-error-message">@error('rg') <span class="error-message">{{ $message }}</span> @enderror</div>                            @else class="input"  name="rg" id="rg" onkeypress="$(this).mask('00-000-000-0')" autocomplete="off" maxlength="9" placeholder="RG" />
                            @endif
                        </div>        
                    </div>        
                    ...
                    <div class="container-erro" style="width: 100%">
                        <div class="container-erro">
                            ...
                            <div class="container-error-message">@error('cpf') <span class="error-message">{{ $message }}</span> @enderror</div>                            @else class="input" name="cpf" id="cpf" onkeypress="$(this).mask('000.000.000-00')" autocomplete="off" maxlength="14" placeholder="CPF" />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="container-erro" style="width: 100%">
                        <div class="container-erro">
                            ...
                            <div class="container-error-message">@error('password') <span class="error-message">{{ $message }}</span> @enderror</div>                            @else class="input" name="password" placeholder="Senha" />
                            @endif 
                        </div>
                    </div>
